export default function Contacts() {
    ...
    <footer className="mt-auto">
        ...
        className="grid grid-cols-2 sm:grid-cols-3 place-items-center 
         transition-all pt-5 text-[1.05rem] lg:text-lg gap-3 sm:gap-0  text-font">
        ...
        <div className="bg-black w-full h-max p-4 dark:border-t-4 dark:border-regos dark:rounded-full">
